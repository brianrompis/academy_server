...
func InitialMigration() {
	...
	// db.Migrator().CreateConstraint(&User{}, "UserVote")
	// db.Migrator().CreateConstraint(&User{}, "fk_user_user_vote")
	...
	db.AutoMigrate(&UserVote{})
	// db.Migrator().CreateConstraint(&SuggestedClassroom{}, "UserVote")
	// db.Migrator().CreateConstraint(&SuggestedClassroom{}, "fk_suggested_classroom_user_vote")
	// db.Migrator().CreateConstraint(&Classroom{}, "UserVote")
	// db.Migrator().CreateConstraint(&Classroom{}, "fk_classroom_user_vote")
